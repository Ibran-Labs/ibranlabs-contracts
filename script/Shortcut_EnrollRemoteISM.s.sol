 ...
 * @dev Script for enrolling remote routers and ISMs for cross-chain communication
 * @notice This contract handles the enrollment of remote routers and ISMs for Base Sepolia and Etherlink Testnet
 * @author Ibran Team
 */
contract ShortcutEnrollRemoteISM is Script {
    ...
    /**
     * @dev Main function to enroll remote routers and ISMs for cross-chain communication
     * @notice This function enrolls the appropriate router and ISM based on the current chain ID
     */
    function run() public {
