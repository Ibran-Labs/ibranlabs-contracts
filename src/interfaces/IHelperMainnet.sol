...
/**
 * @title IHelperMainnet
 * @dev Interface for mainnet helper functionality
 * @notice This interface defines the contract for managing cross-chain configurations in mainnet environments
 * @author Ibran Team
 * @custom:security-contact security@ibran.com
 * @custom:version 1.0.0
 */
interface IHelperMainnet {
    /**
