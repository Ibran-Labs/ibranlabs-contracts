...
/**
 * @title MockWBTC
 * @dev Mock WBTC token contract for testing purposes
 * @notice This contract simulates WBTC token functionality with 8 decimals and bridge capabilities
 * @author Ibran Team
...
contract MockWBTC is ERC20 {
    ...
    /**
     * @dev Constructor for the MockWBTC contract
     * @param _helperTestnet Address of the helper testnet contract
     * @notice Initializes the mock WBTC token with 8 decimals
     */
    ...
    /**
     * @dev Mints new WBTC tokens to a specified address
    ...
    /**
     * @dev Mints mock WBTC tokens for testing purposes
     * @param to Address to receive the minted tokens
     * @param amount Amount of tokens to mint
    ...
    /**
     * @dev Burns mock WBTC tokens for testing purposes
     * @param amount Amount of tokens to burn
     * @notice This function is specifically for testing and development
     * @custom:security This function should only be available in test environments
     */
    ...
    /**
     * @dev Returns the number of decimals for WBTC
     * @return The number of decimal places (8 for WBTC)
     * @notice WBTC uses 8 decimals unlike most ERC20 tokens which use 18
     */
