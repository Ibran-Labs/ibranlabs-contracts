 ...
 * @notice This contract simulates USDC token functionality with 6 decimals and bridge capabilities
 * @author Ibran Team
...
contract MockUSDC is ERC20 {
     ...
     * @notice Initializes the mock USDC token with 6 decimals
     */
    ...
    /**
     * @dev Mints mock USDC tokens for testing purposes
     * @param to Address to receive the minted tokens
     * @param amount Amount of tokens to mint
    ...
    /**
     * @dev Burns mock USDC tokens for testing purposes
     * @param amount Amount of tokens to burn
     * @notice This function is specifically for testing and development
     * @custom:security This function should only be available in test environments
     */
    ...
    /**
     * @dev Returns the number of decimals for USDC
     * @return The number of decimal places (6 for USDC)
     * @notice USDC uses 6 decimals unlike most ERC20 tokens which use 18
     */
