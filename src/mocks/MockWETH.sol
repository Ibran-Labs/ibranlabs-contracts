...
/**
 * @title MockWETH
 * @dev Mock WETH token contract for testing purposes
 * @notice This contract simulates WETH token functionality with 18 decimals and bridge capabilities
 * @author Ibran Team
...
contract MockWETH is ERC20 {
    ...
    /**
     * @dev Constructor for the MockWETH contract
     * @param _helperTestnet Address of the helper testnet contract
     * @notice Initializes the mock WETH token with 18 decimals
     */
    ...
    /**
     * @dev Mints new WETH tokens to a specified address
    ...
    /**
     * @dev Mints mock WETH tokens for testing purposes
     * @param to Address to receive the minted tokens
     * @param amount Amount of tokens to mint
    ...
    /**
     * @dev Burns mock WETH tokens for testing purposes
     * @param amount Amount of tokens to burn
     * @notice This function is specifically for testing and development
     * @custom:security This function should only be available in test environments
     */
    ...
    /**
     * @dev Returns the number of decimals for WETH
     * @return The number of decimal places (18 for WETH)
     * @notice WETH uses 18 decimals like most ERC20 tokens
     */
